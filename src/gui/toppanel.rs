...
pub fn top_panel_show(ui: &mut egui::Ui, gui_state: &mut Gui) {
    ...
    ui.horizontal(|ui|{
        ...
        if *selected_bg != old_selected_bg {
            ...
            gui_state.display_engine.bg_sel_data.selected_map_indexes.clear();
            gui_state.display_engine.clipboard.bg_clip.clear();
            gui_state.display_engine.bg_sel_data.dragging = false;
            gui_state.display_engine.bg_sel_data.selection_width = 0;
        }
